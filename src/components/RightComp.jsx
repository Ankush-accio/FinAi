...
const RightComp = () => {
  ...
  // gemini ai intergration with async function
  const runAi = async () => {
  ...
  return (
  <div className=' w-full sm:w-full md:w-[72vw] border border-l-0 border-t-0 border-gray-300 flex flex-col relative overflow-auto bg-gradient-to-b from-[#f7f7fb] via-[#fafafa] to-[#fdf4f8]'>
      
      {/* icons & btns*/}
      <div className="h-[8vh] items-center text-xl border border-gray-300 p-4 flex border-l-0 border-r-0 justify-between">
      ...
      {/* Conditionally render the initial text and logo based on component state */}
      {showText && <div className="flex flex-col items-center my-auto ">
        ...
        {/* render the logo */}
        {showLoader && <div class="text-center absolute bottom-7 right-4 ">
        <div role="status">
      ...
      {/* render the response of ai  */}
    <div className="flex flex-col p-4 space-y-2 pb-30">
    ...
    {/* footer input */}
    <div className="flex border fixed border-gray-300 justify-between p-3 rounded-2xl bottom-0 w-[95%] sm:w-[70%] md:w-[28vw] m-4">
